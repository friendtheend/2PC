...
def silu(self):
    ...
    if method == "ideal":
        ...
        # Quadratic approximation: SiLU(x) ~= a * x^2 + b * x + c
        a = cfg.functions.silu_d2poly_a
        b = cfg.functions.silu_d2poly_b
        c = cfg.functions.silu_d2poly_c
        return self.square().mul(a).add(self.mul(b)).add(c)
    elif method == "fourier":
